...
router.post("/newproductadd",upload.array("image"),NewarrivalController.newproductadd)
router.get("/newgetproduct", requireAuth,NewarrivalController.newgetproduct)
router.get("/editnewgetProdcut/:id", NewarrivalController.editnewgetProdcut)
router.delete("/newproductDelete/:id", NewarrivalController.newproductDelete)
router.put("/neweditproduct/:id",upload.array("image"), NewarrivalController.neweditproduct)
